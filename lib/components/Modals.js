...
import renderTimeAvailabilityOptions from "./TimeAvailabilityOptions.js"
...
export const RescheduleModal = async (appointmentID) => {
  ...
  await renderTimeAvailabilityOptions("editTime")
...
const RescheduleModalMarkup = async (
  ...
  dateStr,
  timeStr
) => `<div id="rescheduleModal" class="modal modal-open">
        <div class="modal-box flex flex-col gap-4">
