// Fetching all my Appointments within my respective Cloudstore Collection
...
// Fetching a single Appointment within my respective Cloudstore Collection
...
// POSTING a new appointment that is containing a valid date to the respetive Cloustore Collection
...
export const updateAvailability = async (id, current) => {
  try {
    const Availability = await fetch("/.netlify/functions/PUT_Availability", {
      method: "PUT",
